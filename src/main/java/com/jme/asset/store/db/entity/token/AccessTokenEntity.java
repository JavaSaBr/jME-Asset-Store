package com.jme.asset.store.db.entity.token;
...
/**
 * The access token of authed users.
 *
 * @author Alex Brui
 */
@Entity
...
public class AccessTokenEntity extends BaseEntity {
    ...
    public AccessTokenEntity(final long id, @Nullable final String token, final long userId,
